    ...
    return html.Div(
        [
            ...
            html.Div(
                ...
                style={"fontSize": "12px", "color": delta_color, "marginTop": "4px"},
            ),
            html.Div(
                style={
                    "height": "3px",
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.Div(
                            id="kpi-total-rides", style={"flex": "1", "margin": "0 8px"}
                        ),
                        html.Div(
                            id="kpi-revenue", style={"flex": "1", "margin": "0 8px"}
                        ),
                        html.Div(
                            id="kpi-total-orders",
                        ...
                        html.Div(
                            id="kpi-avg-surge", style={"flex": "1", "margin": "0 8px"}
                        ),
                        html.Div(
                            id="kpi-anomalies", style={"flex": "1", "margin": "0 8px"}
                        ),
                    ],
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Graph(
                                    id="surge-heatmap", style={"height": "380px"}
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Graph(
                                    id="revenue-chart", style={"height": "380px"}
                                ),
                            ],
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Graph(
                                    id="hourly-demand", style={"height": "300px"}
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Graph(
                                    id="delivery-perf", style={"height": "300px"}
                                ),
                            ],
                            style={**CARD_STYLE, "flex": "1"},
                        ),
                                ...
                                html.Div(
                                    [
                                        dcc.Input(
                                            id="chat-input",
                                            type="text",
                                            placeholder="Ask about your data... e.g. 'Why is surge high in Bandra today?'",
                                            style={
                                                "flex": "1",
                                                "backgroundColor": COLORS["bg"],
...
@app.callback(
    [
        Output("kpi-total-rides", "children"),
        Output("kpi-revenue", "children"),
        Output("kpi-total-orders", "children"),
        Output("kpi-gmv", "children"),
        Output("kpi-avg-surge", "children"),
...
def update_kpis(_):
    ...
    return [
        ...
        kpi_card(
            "Ride Revenue",
            f"₹{rides.get('revenue_inr', 0)/1e5:.1f}L",
            "+12.1%",
            icon="💰",
            color=COLORS["success"],
        ),
        ...
        kpi_card(
            "Food GMV",
            f"₹{orders.get('gmv_inr', 0)/1e5:.1f}L",
            "+19.7%",
            icon="🏦",
        ...
        kpi_card(
            "Avg Surge",
            f"{rides.get('avg_surge', 1.0):.2f}x",
            "+0.08x",
            icon="⚡",
            color=COLORS["warning"],
        ),
        kpi_card(
            "Anomalies",
            f"{combined.get('anomalies_detected', 0)}",
            "-5 vs avg",
            icon="🚨",
            color=COLORS["danger"],
        ),
...
def update_heatmap(_):
    zones = [
        ...
        },
        {
            ...
            "rides": random.randint(300, 1200),
        },
        {
            "name": "Dadar",
            "lat": 19.0178,
            "lon": 72.8478,
            "surge": random.uniform(1.0, 1.8),
            "rides": random.randint(400, 1500),
        },
        {
            "name": "Juhu",
            "lat": 19.1075,
            "lon": 72.8263,
            "surge": random.uniform(1.2, 2.2),
            "rides": random.randint(200, 900),
        },
        {
            "name": "Lower Parel",
            "lat": 18.9956,
            "lon": 72.8258,
            "surge": random.uniform(1.3, 2.5),
            "rides": random.randint(600, 1800),
        },
        {
            "name": "Malad East",
            "lat": 19.1871,
            "lon": 72.8485,
            "surge": random.uniform(1.0, 1.5),
            "rides": random.randint(300, 1100),
        },
        {
            "name": "Powai",
            "lat": 19.1176,
            "lon": 72.9060,
            "surge": random.uniform(1.1, 2.0),
            "rides": random.randint(400, 1400),
        },
        {
            "name": "Thane",
            "lat": 19.2183,
            "lon": 72.9781,
            "surge": random.uniform(1.0, 1.6),
            "rides": random.randint(200, 900),
        },
        {
            "name": "Borivali",
            "lat": 19.2307,
            "lon": 72.8567,
            "surge": random.uniform(1.0, 1.4),
            "rides": random.randint(200, 800),
        },
        {
            "name": "Navi Mumbai",
            "lat": 19.0330,
            ...
            "rides": random.randint(100, 600),
        },
        {
            "name": "Airport",
            "lat": 19.0896,
            "lon": 72.8656,
            "surge": random.uniform(1.5, 2.8),
            "rides": random.randint(500, 1600),
        },
    ]
    ...
    fig = go.Figure(
        go.Scattermapbox(
            ...
            text=[
                f"<b>{r['name']}</b><br>Surge: {r['surge']:.1f}x<br>Rides: {r['rides']:,}"
...
def update_hourly(_):
    hours = list(range(24))
    actual = [
        max(0, int(100 * m + random.gauss(0, 15)))
        for m in [
            0.15,
            0.1,
            0.08,
...
def handle_chat(n_clicks, question, history):
    ...
    history.append(
        html.Div(
            [
                html.Span(
                    "You: ", style={"color": COLORS["accent"], "fontWeight": "700"}
                ),
    ...
    try:
        r = requests.post(
            f"{API_BASE}/insights/ask", json={"question": question}, timeout=15
        )
    ...
    history.append(
        html.Div(
            [
                html.Span(
                    "🤖 AI: ", style={"color": COLORS["primary"], "fontWeight": "700"}
                ),
